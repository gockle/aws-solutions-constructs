# aws-codebuild-codepipeline module
...
| **Language**     | **Package**        |
|:-------------|-----------------|
|![Python Logo](https://docs.aws.amazon.com/cdk/api/latest/img/python32.png) Python|`aws_solutions_constructs.aws_codebuild_codepipeline`|
|![Typescript Logo](https://docs.aws.amazon.com/cdk/api/latest/img/typescript32.png) Typescript|`@aws-solutions-constructs/aws-codebuild-codepipeline`|
|![Java Logo](https://docs.aws.amazon.com/cdk/api/latest/img/java32.png) Java|`software.amazon.awsconstructs.services.codebuild.codepipeline`|

This AWS Solutions Construct implements an AWS CodeBuild to AWS CodePipeline with CodeCommit/Github/S3 as the source repository.
